...
function Boton({ titulo }: { titulo: string }) {
  ...
  return (
    <button
      type="submit"
      disabled={pending}
      className="flex items-center gap-1 rounded-full px-2.5 py-0.5 text-[12px] text-white disabled:opacity-60 focus-visible:outline-2 focus-visible:outline-offset-2"
